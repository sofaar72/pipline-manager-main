...
import loginBg from "/images/login-bg5.svg";
import welcomeTop from "/images/loginTopLayer.svg";
import welcome from "/images/welcome-bg.png";

const LoginWelcome = ({ isSmallView }) => {
  return (
    <div className="w-full basis-2/3 h-full relative ">
      <img
