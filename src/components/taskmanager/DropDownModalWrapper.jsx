...
import TeamSelectComp from "../projects/TeamSelectComp";
...
DropDownModalWrapper.TypeTwo = ({ menuStyle = "normal" }) => {
  ...
  if (menuStyle === "members") {
    return (
      ...
      >
        <TeamSelectComp members={items} setMembers={setItems} />
      </div>
    );
  }
};
